...
setup(
    ...
    description="A Python Dataclass typehint check",  # Optional
    ...
    url="https://github.com/vtheno/neko-typehint",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="vtheno",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="o@0oo.ooo",  # Optional
    ...
    keywords="dataclass typehint instancecheck",  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/vtheno/neko-typehint/issues",
        # "Funding": "https://donate.pypi.org",
        # "Say Thanks!": "http://saythanks.io/to/example",
        "Source": "https://github.com/vtheno/neko-typehint",
    },
)
